    ...
    <div className={`flex flex-col ${reversed ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-stretch gap-0 mb-0`}>
      ...
      <div className="w-full lg:w-1/2 bg-[rgba(248,248,248,1)]">
        <div className={`flex flex-col justify-center h-full min-h-[400px] lg:min-h-[600px] px-6 lg:px-12 xl:px-20 py-16 lg:py-[110px] ${reversed ? 'lg:pr-6 xl:pr-12' : 'lg:pl-6 xl:pl-12'}`}>
          <h3 className="text-czarny text-2xl lg:text-[42px] font-barlow-condensed font-semibold tracking-[1.26px] mb-6 leading-tight">
            {title}
          </h3>
...
const FeaturesContainer = () => {
  const features = [
    ...
    },
    {
      ...
      features: [
        "Praca z AI to sposób na poprawę efektywności i wyników finansowych bo zyskujesz czas",
        "Komfort pracy - nie przepisujesz ofert ręcznie"
      ],
  ...
  return (
    <section className="w-full max-w-[1520px] mt-[111px] max-md:max-w-full max-md:mt-16">
      <div className="mb-16 lg:mb-20 px-6 lg:px-8">
        <h2 className="text-czarny text-center text-3xl lg:text-[42px] font-barlow-condensed font-semibold tracking-[1.26px] uppercase mb-4">
          ...
          <span className="lowercase"> funkcjonalności</span>
        </h2>
        <p className="text-czarny text-center text-lg font-roboto-condensed font-normal leading-6 max-w-2xl mx-auto">
          Poznaj kluczowe funkcje systemu, które usprawniają codzienną pracę firm transportowych
        </p>
      </div>
